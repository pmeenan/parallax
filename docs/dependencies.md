...
| `@babylonjs/ktx2decoder` 9.27.1 and package-owned WASM | 9.28.0 (registry checked 2026-09-24) | **Adopted 2026-09-24** (from 9.17.0). Its WASM binaries are byte-identical to 9.17.0's. Its uncompressed RGBA8 transcoder replaced the engine-owned `ktx2-rgba8.ts` reader. 9.28.0 is a minor release, eligible 1 day after its 2026-09-24 publish. | With the next Lite review: exact binary hashes, wrapper/API inspection, decoder fixtures. |
