...
export const PSO_WARMUP_RENDERER = "@babylonjs/lite@1.31.1";
...
export const PBR_VERTEX_WGSL_SHA256 =
  "dc697137e5b3aaf9dcb17fd835a870a572cc894bc234ab7ec090003eadd66dcf";
export const PBR_FRAGMENT_WGSL_SHA256 =
  "2e9152e4024089c866edf57a0b380f4fe23c2dda7cc1b0bc8ddfc8a37849fb54";
const PBR_MATERIAL_GROUP = {
  entries: [
    // The terrain drape (D-204) reads the material UBO in the vertex stage too.
    STANDARD_OPAQUE_STATE.layout.bindGroups[1].entries[0],
    { ...STANDARD_OPAQUE_STATE.layout.bindGroups[1].entries[1], visibility: 3 },
...
export const PBR_COLOR_STATE = deepFreeze({
  ...
  // Streamed PBR geometry draws from one interleaved 32-byte slab (position, normal, UV):
  // Lite binds the same buffer to each attribute slot at the attribute's offset.
  vertexBuffers: [
    {
      arrayStride: 32,
      attributes: [{ format: "float32x3", offset: 0, shaderLocation: 0 }],
