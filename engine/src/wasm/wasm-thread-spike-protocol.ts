// wasm-bindgen 0.2.127 raises the linker's fixed 32-page shared-memory import by one
...
// These are exact upstream-reserved offsets in the pinned nightly-2026-07-16 /
// wasm-bindgen 0.2.127 fixture, not a general wasm-bindgen ABI. build-wasm.mjs
// disassembles the optimized shipped output and fails if the runtime layout
