...
export const SIMULATION_GAMEPLAY_STEP_BUDGET_MS = 2;
...
export function evaluateSimulationGameplayBudget(
  stepDurationHighWaterMs: number,
): readonly BudgetCheck[] {
  return Object.freeze([
    check(
      SMOKE_BUDGET_METRICS.simulationGameplayStepHighWaterMs,
