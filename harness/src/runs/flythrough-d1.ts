...
export const FLYTHROUGH_D1_REPORT_SCHEMA_VERSION = 37;
export const FLYTHROUGH_D1_TRACE_BUFFER_KIB = 1_048_576;
export const FLYTHROUGH_D1_MANDATORY_METRIC_SET_VERSION = 11;
export const FLYTHROUGH_D1_TELEMETRY_SCHEMA_VERSION = 48;
