...
three LODs, with vertex and index streams per LOD, and share eight UASTC maps that reach the
GPU as BC7 (D-199). Three canonical GLBs complete the 29 immutable library objects. They remain
export evidence and are not duplicate runtime bytes. Every texel and vertex is procedural-original project output
