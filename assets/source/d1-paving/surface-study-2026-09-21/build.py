...
CYCLE = int(globals().get('STUDY_CYCLE', 11))
...
def stone_material(seed,texture_offset):
    ...
    col=ramp(n,l,macro_tex.outputs['Color'],'Worn mineral reflectance multiplier',[
        (.25,(.37,.30,.23)),(.43,(.18,.18,.17)),(.60,(.20,.20,.19)),(.68,(.46,.43,.38)),(.76,(.85,.77,.67)),(.88,(.9,.83,.7))])
