...
OUT=ROOT/f'portable-cycle{CYCLE}'
...
source=next(o for o in bpy.data.scenes[f'Complete limestone study cycle{CYCLE}'].objects if o.name.startswith('Surface study master'))
