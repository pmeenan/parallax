...
scene=bpy.data.scenes[f'Complete limestone study cycle{CYCLE}']
bpy.context.window.scene=scene
stone=next(o for o in scene.objects if o.type=='MESH' and o.name.startswith('Surface study master'))
