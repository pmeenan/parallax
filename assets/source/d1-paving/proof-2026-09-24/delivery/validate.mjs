// Khronos glTF validator over the three standard delivery GLBs.
// node validate.mjs <pack dir>
...
for (let lod = 0; lod < 3; lod++) {
  ...
  reports.push({ file, issues: report.issues, info: report.info });
...
if (reports.some((r) => r.issues.numErrors > 0)) process.exitCode = 1;
