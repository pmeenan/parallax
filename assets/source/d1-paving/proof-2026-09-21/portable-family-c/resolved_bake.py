...
CYCLE=203
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-21\\portable-family-c');OUT.mkdir(exist_ok=True)
START=time.perf_counter()
source_scene=bpy.data.scenes['Family C export source']
