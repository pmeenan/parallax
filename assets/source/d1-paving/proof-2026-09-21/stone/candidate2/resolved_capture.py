...
scene=bpy.data.scenes['Paving proof stone candidate2']
bpy.context.window.scene=scene
stone=next(o for o in scene.objects if o.type=='MESH' and o.name.startswith('Paving proof stone candidate2 master'))
