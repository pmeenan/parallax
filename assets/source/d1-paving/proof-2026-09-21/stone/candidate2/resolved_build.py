...
CYCLE = 102
OUT = Path('D:/src/parallax/assets/source/d1-paving/proof-2026-09-21/stone/candidate2')
...
scene=bpy.data.scenes.new('Paving proof stone candidate2')
bpy.context.window.scene=scene
scene.unit_settings.system='METRIC';scene.unit_settings.scale_length=1
stone=make_stone('Paving proof stone candidate2 master')
