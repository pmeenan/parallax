...
CYCLE = 103
OUT = Path('D:/src/parallax/assets/source/d1-paving/proof-2026-09-21/stone/candidate3')
...
# Compressed chromatic modulation from the retained generated albedo.
...
def make_stone(name,seed=713,hx=.2,hy=.15,hz=.04,res=1):
    ...
    for i in range(9):
        ...
        p-=norm*loss[:,None]
    # Three localized shallow fractures interrupt the long shaved corner facets.
...
scene=bpy.data.scenes.new('Paving proof stone candidate3')
bpy.context.window.scene=scene
scene.unit_settings.system='METRIC';scene.unit_settings.scale_length=1
stone=make_stone('Paving proof stone candidate3 master')
