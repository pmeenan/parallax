...
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-21\\portable-family-b')
...
source=next(o for o in bpy.data.scenes['Family B export source'].objects if o.name.startswith('Family B'))
