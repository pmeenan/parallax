...
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-21\\portable-family-a')
...
source=next(o for o in bpy.data.scenes['Family A export source'].objects if o.name.startswith('Family A'))
