...
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-21\\portable-stone3')
...
source=next(o for o in bpy.data.scenes['Paving proof stone candidate3'].objects if o.name.startswith('Paving proof stone candidate3 master'))
