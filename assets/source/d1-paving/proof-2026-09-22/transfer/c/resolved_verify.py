...
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-22\\transfer\\c')
...
source=next(o for o in bpy.data.scenes['Restored C transfer source'].objects if o.name.startswith('Family C'))
