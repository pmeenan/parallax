...
CYCLE=302
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-22\\transfer\\b');OUT.mkdir(exist_ok=True)
START=time.perf_counter()
source_scene=bpy.data.scenes['Restored B transfer source']
...
high=next(o for o in scene.objects if o.name.startswith('Family B'))
