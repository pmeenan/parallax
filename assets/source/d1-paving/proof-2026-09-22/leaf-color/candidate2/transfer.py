...
export_start=time.perf_counter();bpy.ops.export_scene.gltf(filepath=str(OUT/'representative-weed.glb'),export_format='GLB',use_selection=True,use_active_scene=True,export_materials='EXPORT',export_vertex_color='NAME',export_vertex_color_name='LeafAgeTint',export_all_vertex_colors=False);export_seconds=time.perf_counter()-export_start
