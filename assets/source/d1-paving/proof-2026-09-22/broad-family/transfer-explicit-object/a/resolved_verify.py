...
OUT=Path('D:\\src\\parallax\\assets\\source\\d1-paving\\proof-2026-09-22\\broad-family\\transfer-explicit-object\\a')
...
source=next(o for o in bpy.data.scenes['Broad A transfer source'].objects if o.name.startswith('Broad source A'))
...
report={'checkedUtc':datetime.now(timezone.utc).isoformat(),'glbSha256':hashlib.sha256(raw).hexdigest(),
 ...
 'importSeconds':import_seconds,'closedManifold':manifold,'finiteCoordinates':True,'finiteUVsWithinUnitSquare':True,
